...
log()  { echo -e "${GREEN}[integrity-checker]${NC} $*"; }
warn() { echo -e "${YELLOW}[integrity-checker]${NC} $*"; }
err()  { echo -e "${RED}[integrity-checker]${NC} $*" >&2; }
...
log "Starting integrity-checker"
